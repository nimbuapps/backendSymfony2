...
/* NotificacionBundle:Negocio:show.html.twig */
class __TwigTemplate_38fa9fc90e3fba93ba6e63137c31dee4a982d28fc5908dcaf5e48b246b26e0fd extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 38
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("negocio_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "NotificacionBundle:Negocio:show.html.twig";
    }
