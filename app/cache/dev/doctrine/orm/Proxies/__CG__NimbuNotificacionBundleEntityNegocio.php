 ...
 */
class Negocio extends \Nimbu\NotificacionBundle\Entity\Negocio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Nimbu\\NotificacionBundle\\Entity\\Negocio' . "\0" . 'id', '' . "\0" . 'Nimbu\\NotificacionBundle\\Entity\\Negocio' . "\0" . 'nombre', '' . "\0" . 'Nimbu\\NotificacionBundle\\Entity\\Negocio' . "\0" . 'direccion', '' . "\0" . 'Nimbu\\NotificacionBundle\\Entity\\Negocio' . "\0" . 'telefono', '' . "\0" . 'Nimbu\\NotificacionBundle\\Entity\\Negocio' . "\0" . 'logo', '' . "\0" . 'Nimbu\\NotificacionBundle\\Entity\\Negocio' . "\0" . 'pack');
        }
